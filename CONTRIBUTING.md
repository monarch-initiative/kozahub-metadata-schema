# Contributing to kozahub-metadata-schema

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
kozahub-metadata-schema. These guidelines are not strict rules.
...
The kozahub-metadata-schema team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the kozahub-metadata-schema technical leads
...
[issues]: https://github.com/monarch-initiative/kozahub-metadata-schema/issues/
[pulls]: https://github.com/monarch-initiative/kozahub-metadata-schema/pulls/
